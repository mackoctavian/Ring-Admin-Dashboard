...
import { deleteItem } from "@/lib/actions/section.actions"
      ...
      try {
          if (data) {
              ...
              toast({
                  variant: "default",
                  title: "Success", 
                  description: "Section/space deleted successfully!"
              });
          } else {
            toast({
              variant: "destructive",
    ...
    <>
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => router.push(`/dashboard/sections/${data.$id}`)}>
