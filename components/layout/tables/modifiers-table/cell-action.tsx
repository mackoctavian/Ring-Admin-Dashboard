...
import { deleteItem } from "@/lib/actions/modifier.actions"
      ...
      try {
          if (data) {
              ...
              toast({
                  variant: "default",
                  title: "Success", 
                  description: "Modifier deleted succesfully!"
              });
          } else {
            toast({
              variant: "destructive",
    ...
    <>
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => router.push(`/dashboard/modifiers/${data.$id}`)}>
