...
import { deleteItem } from "@/lib/actions/inventory.actions"
      ...
      try {
          if (data) {
              ...
              toast({
                  variant: "default",
                  title: "Success", 
                  description: "Inventory item deleted succesfully!"
              });
          } else {
            toast({
              variant: "destructive",
    ...
    <>
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => router.push(`/inventory/${data.inventory.$id}`)}>
