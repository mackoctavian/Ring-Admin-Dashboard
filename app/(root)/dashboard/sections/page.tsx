...
const breadcrumbItems = [{ title: "Spaces", link: "/dashboard/sections" }]
            ...
            <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
                ...
                <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center space-x-2">
                        <Link href={`/dashboard/sections/new`}
                            ...
                            <span className="sr-only sm:not-sr-only sm:whitespace-nowrap"> Add Space / Section </span>
                        </Link>
                    </div>
                </div>
                ...
                {total > 0 || q != null ? (
                    <Card x-chunk="data-table">
                        <CardHeader>
                            <CardTitle>Spaces, sections & rooms</CardTitle>
                            <CardDescription>
                                Manage spaces, sections and rooms within your business
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <DataTable
